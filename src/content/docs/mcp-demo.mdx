...
description: "The reference MCP server closes the end-to-end agentic loop: receive a tool call, build a twin, run the primitive, serialize the dataclass result, return it."
---
...
:::note
The MCP server's 10 tools are a curated subset of the 21 primitives shipped in DeFiPy. See [Tool Schemas](/agentic-tool-schemas/) for the curation rationale and [Agentic Primitives](/agentic-primitives/) for the full primitive catalog.
:::
