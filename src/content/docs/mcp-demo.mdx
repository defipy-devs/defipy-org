---
title: "MCP Server Demo Walkthrough"
description: "The reference MCP server at python/mcp/defipy_mcp_server.py closes the end-to-end agentic loop: receive a tool call, build a twin, run the primitive,…"
---
...
:::note
The MCP server's 10 tools are a curated subset of the 21 primitives shipped in DeFiPy. See [tool_schemas](/agentic-tool-schemas/) for the curation rationale and [agentic_primitives_by_category](/agentic-primitives/) for the full primitive catalog.
:::
