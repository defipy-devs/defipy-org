...
description: "Every agentic primitive returns a typed dataclass — no raw tuples, no dicts, no strings. Callers (human or LLM) can rely on named fields. This page catalogs…"
---
...
:::
For the primitive that returns each dataclass, see [agentic_categories](/agentic-primitives/).
