...
For the full conceptual treatment — including custom providers, the LiveProvider stub, and the snapshot → builder → primitive pipeline — see the [Twin Concept](/twin-concept/).
