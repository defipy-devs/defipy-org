...
Initialize a pool with starting liquidity. `Join` is a **mutating** dispatch primitive — it routes to the protocol-specific mint operation underneath the unified interface. See [The Primitive Contract](/primitive-contract/) for the cross-cutting invariants every dispatcher follows.
...
- [The Primitive Contract](/primitive-contract/) — the cross-cutting invariants every dispatcher follows
