...
description: "Every analytics primitive in DeFiPy follows the same three-line contract: stateless construction, computation at apply(), typed dataclass return."
---
