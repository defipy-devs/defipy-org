...
description: "v2.0 ships MCP schemas only. Anthropic tool-use and OpenAI function-calling adapters are deferred to v2.1 and will be derivable from the shipped MCP schemas…"
---
...
2.  **Wait for v2.1.** Timeline tracked in [roadmap](/roadmap/).
