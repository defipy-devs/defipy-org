...
description: "From desktop tool to industrial infrastructure. v1 was built for the research analyst — a library you imported into a notebook to answer questions about a…"
---
...
See [roadmap](/roadmap/) for the full v2.1+ timeline.
