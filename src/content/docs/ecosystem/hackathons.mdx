---
title: "Hackathons"
description: "DeFiPy has been built and showcased in multiple hackathons focused on DeFi analytics, simulation, and live on-chain modeling."
---
...
![DeFiPy presented at ETHDenver 2024 with the 0x judging panel](/img/ethdenver_2024_0x_judges.png)

🔗 [Link to project page →](https://devfolio.co/projects/defi-paper-trading-live-modeling-tool-with-x-5d78)
...
including Uniswap v2 refactor and a live dashboard driven by 0x price feeds.
...
🔗 [Link to project page →](https://taikai.network/cryptocanal/hackathons/ethdam2024/projects/clux0p0rv00lmz301nq7yw7t1/idea)
