			...
			head: [
				{
					...
					attrs: {
						async: true,
						src: 'https://www.googletagmanager.com/gtag/js?id=G-TVT5JQT6WV',
					},
				},
				{
					tag: 'script',
					content: `window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'G-TVT5JQT6WV');`,
				},
			],
